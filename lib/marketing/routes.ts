...
export const MARKETING_ROUTES: MarketingRoute[] = [
  {
    ...
    intent: "Эмоциональный вход в ФотоЛови как live event experience: гости, QR, экран, проектор и общий момент",
    priority: "P0",
  },
  {
    title: "Свадебный раздел",
    path: "/wedding/",
    parentPath: "/",
    level: 1,
    pageType: "контентный раздел",
    intent: "Идеи и сценарии для свадьбы: QR, экран, гостевые фотографии и участие гостей",
    priority: "P0",
  },
  {
  ...
  },
  {
    ...
    level: 2,
    pageType: "гайд",
    intent: "Сценарий свадебного проектора: приветствие, QR, фотографии гостей и финальный экран",
    priority: "P1",
  },
  {
    ...
    parentPath: "/screen/",
    level: 2,
    pageType: "редакционная подборка",
    intent: "Идеи для live screen на свадьбе: когда показывать фотографии и как не перебить программу",
    priority: "P2",
  },
  {
    title: "Ведущим",
    ...
    parentPath: "/",
    level: 1,
    pageType: "редакционный раздел",
    intent: "Как ведущему встроить фото-интерактив, QR и экран в программу события",
    priority: "P1",
  },
  {
  ...
  },
  {
    ...
    parentPath: "/alternatives/",
    level: 2,
    pageType: "сравнительный гайд",
    intent: "Разобрать, почему чаты и облака хуже работают для сбора фотографий во время события",
    priority: "P1",
  },
  {
    title: "Идеи",
  ...
  },
  {
    ...
    parentPath: "/ideas/",
    level: 2,
    pageType: "редакционный гайд",
    intent: "Идеи цифрового интерактива на свадьбе: QR, экран, гостевые кадры и спокойный сценарий",
    priority: "P2",
  },
  {
